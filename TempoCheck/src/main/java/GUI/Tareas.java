...
public class Tareas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("! Bienvenido a la sección Tareas ¡");

        jLabel8.setText("Aca podrás crear tareas y llevar un seguimiento y control");

        jLabel9.setText("También podras categorizarlas segun importancia");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tareas", "Importancia", "Fecha", "Hecho"
            }
        ) {
        ...
        jButton1.setText("<html><center> Agregar Tarea</center></html>");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "(Importancia)", "Alta", "Media", "Baja", "(Nivel de esfuerzo)", "Mañana", "Tarde", "Noche" }));
        ...
        jButton2.setText("<html><center>Eliminar Tarea</center></html>");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        if(jToggleButton1.isSelected()) {
            ...
            // Si el botón de alternancia no está seleccionado, cambiar al modo claro (predeterminado)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String fechaLimite = jTextField2.getText();
        
        
        DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
        
        Object[] fila  = {text,importancia,fechaLimite};
        modelo.addRow(fila);
