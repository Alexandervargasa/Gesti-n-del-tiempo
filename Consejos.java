package com.mycompany.tempocheck.igu;
...
public class Consejos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consejos");

        jLabel2.setText("¡ Bienvenido a la seccion de consejos !");

        jLabel3.setText("Aca encontraras algunos consejos sobre salud mental y");

        jLabel5.setText("sobre como optimizar y priorizar tareas, con el objetivo de");

        jLabel6.setText("que se pueda complementar con el resto de la App");

        jLabel7.setText("y tener un mejor manejo del tiempo. (Califica los consejos)");
        ...
        jLabel8.setText("Prioriza tu salud mental: practica actividades que te brinden calma y");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel9.setText("alegría, como la meditación y el ejercicio regular. Establece límites");

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel10.setText("saludables en tus relaciones y no dudes en pedir ayuda si la ");

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel11.setText("necesitas. Recuerda que está bien no estar bien a veces,");
        ...
        jLabel12.setText("Para optimizar y priorizar tareas, establece metas claras, haz una");

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel13.setText("lista y ordena por importancia y urgencia. Dedica tiempo a las de");

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel14.setText("alta prioridad, delega o elimina las menos relevantes. Utiliza ");

        jLabel15.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel15.setText("herramientas de organización, revisa tus prioridaes y enfoques");
        ...
        jLabel16.setText("Para manejar bien el tiempo, fija metas claras, usa herramientas de");

        jLabel17.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel17.setText("planificación, prioriza tareas, evita la multitarea, aprende a decir  ");

        jLabel18.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel18.setText("\"no\", y usa técnicas como la técnica  de estudio que las podrás.");

        jLabel19.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel19.setText("encontrar en la seccion metodos de estudio");
        ...
        jLabel20.setText("Los métodos de estudio son esenciales para aprender de manera ");

        jLabel21.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel21.setText("efectiva, ayudándote a organizar y retener información de manera");

        jLabel22.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel22.setText("más eficiente, lo que te prepara mejor para exámenes y tareas");

        jLabel23.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        jLabel23.setText("academicas o laborales");
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jCheckBox16, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
